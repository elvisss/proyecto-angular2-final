...
export class RestauranteService {
  ...
  addRestaurante(restaurante: Restaurante) {
    ...
    return this._http.post('http://localhost/slim/restaurantes-api.php/restaurantes', params, {headers: headers})
      .map(res => {
        // if (res.status == 200) {
          return res.json()
        // } else {
  ...
  editRestaurante(id: string, restaurante: Restaurante) {
    ...
    return this._http.post('http://localhost/slim/restaurantes-api.php/update-restaurante/' + id, params, {headers: headers})
      .map(res => {
        // if (res.status == 200) {
          return res.json()
        // } else {
